  ...
  
{
    ...
    public Text coachText; //Tells user whether they hit or missed a shot
    public Text targetText; //Tells the user what the current target is
    ...
    public double extraDecimal; //RENAME ASAP
    public static string goalString;
    public int numberOfBalls; //Should be at zero
    ...
    public GameObject startButton; //REWORK to continueButton
    public GameObject shootButton; //UI Button for shooting

    //Selection buttons for future implementation
  ...
  //  public GameObject fourthsButton;
   // public GameObject thirdsButton;
    //public GameObject buttonLink; //Links to other intervention studiesS

    public GameObject IntroUI; //this is called playing yourself - don't ever
    public GameObject titleCard; //bruh whats the difference between the two

    public GameObject numberline;
   // public GameObject thirds_spaces; //will probably use these but nothing now
 //   public GameObject fourths_spaces; //will probably use these but nothing now
  ...
  //  float startCountdown = 3.9F; // 3 seconds
    ...
    void Start()
    {
        ...
        } catch (System.Exception e)
        {
            ...
            InputField iField = userIDInput.GetComponent<InputField>();
